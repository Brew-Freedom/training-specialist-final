...
# Base project folder
project_folder = '/mnt/data/training-specialist-demo-ready'
...
# index.html with example buttons
...
## Overview
Interactive project demonstrating sentiment analysis, trainable AI, dataset quality charts, numeric predictions, and image labeling with preloaded examples.

## Instructions
Open index.html in a browser. Click the example buttons or upload CSV/images to run demos.

## QA
Manual testing, debugging, automated tests, regression testing.

## Demo Ready Features
- Preloaded CSVs: dirty.csv, clean.csv
- Sentiment Analyzer example sentences
- Pre-added training words: amazing, horrible
- Numeric prediction example buttons
- Image labeling sample images and buttons
''' 
with open(project_folder + '/README.md','w') as f:
    f.write(readme_md)

# Create ZIP
zip_path='/mnt/data/training-specialist-demo-ready.zip'
